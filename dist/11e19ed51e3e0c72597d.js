...
document.getElementById('translate-to-arabic').addEventListener('click', async function() {
    const translatorContainer = document.getElementById('translator-container');
    try {
        const translation = await googleTranslateApi.translate('This is a sample web page.', { to: 'ar' });
        translatorContainer.textContent = translation.text;
    } catch (error) {
